...
for klm=1:numel(mess)
    ...
    % In slices 1 and 3 there are some tracing errors, meaning that there are
    % spots "traced" in one corner of the image. Dont know how that happened,
    % maybe the graphic tablet had some issus. That is why these spots are
    % filtered out with the if clause.
...
%Here Silviomanually defines the layer9, because the layer9 cannot be
%traced with the remaining head structure, because of a bug in the script.
%it cannot handle disconnected structures for the PM...
