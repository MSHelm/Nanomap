function program_normalize_by_division_by_background_non_cellular
...
mush=dlmread(['Mush_' channels{k} '_average_150px_myfilt_total.txt']);
flat=dlmread(['Flat_' channels{k} '_average_150px_myfilt_total.txt']);
other=dlmread(['Other_' channels{k} '_average_150px_myfilt_total.txt']);
...
%         end
    ...
    cd (the_folder)
    dlmwrite([channels{k} '_matrix_differential_intensities.txt'],matrix)
...
xlswrite('DifferentialIntensities.xlsx',results);
...
save('DifferentialIntensities.mat','tab');
