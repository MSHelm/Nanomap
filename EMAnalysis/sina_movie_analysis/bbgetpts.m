function [x,y] = bbgetpts(varargin)

% same as getpts except pointer is circle
%        see line 79
...
%   $Revision: 1.12 $  $Date: 1998/09/29 16:24:50 $
...
set(GETPTS_FIG, 'WindowButtonDownFcn', 'getpts(''FirstButtonDown'');', ...
     ...
     % bb 03/01: changed 'custom' to 'circle' in line above
