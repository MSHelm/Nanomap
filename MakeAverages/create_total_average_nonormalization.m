function create_total_average_nonormalization
...
avg_type={'_150px_myfilt'};%'_150px_myfilt_nostedfilt','_150px_nodiofilt_nostedfilt','_150px_nodiofilt_stedfilt'}; %
...
%                         end
                        ...
                        % %                         max(img_rep2(:))
                        % img_rep2=(img_rep2/max(img_rep2(:)))*255;
                        % %                         max(img_rep1(:))
                        % img_rep1=(img_rep1/max(img_rep1(:)))*255;
                        ...
                        save(['Z:\user\mhelm1\Nanomap_Analysis\Data\total\' proteinname '_UID-' UID filesep 'CombinedImageStack_' classes{j} '_' channels{k} avg_type{l} '_nonormalization.mat'],'img_both')
                        dlmwrite(['Z:\user\mhelm1\Nanomap_Analysis\Data\total\' proteinname '_UID-' UID filesep classes{j} '_' channels{k} '_average' avg_type{l} '_total_nonormalization.txt'],avg);
                        dlmwrite(['Z:\user\mhelm1\Nanomap_Analysis\Data\total\' proteinname '_UID-' UID filesep classes{j} '_' channels{k} '_average' avg_type{l} '_total_sd_nonormalization.txt'],sd);
                        dlmwrite(['Z:\user\mhelm1\Nanomap_Analysis\Data\total\' proteinname '_UID-' UID filesep classes{j} '_' channels{k} '_average' avg_type{l} '_total_sem_nonormalization.txt'],sem);
                    end
                end
            end
        end
