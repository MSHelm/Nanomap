...
for i=1:numel(folders)
    ...
    %     Used to manually insert the placeholders for GluN2A and Kir2.1 here
    %     if strcmp('Grin2a',UID) %GluN2A
    %         results{i+1,copynum_from_Homer_indx}=50;
    %     elseif strcmp('Kcnj2',UID) %Kir2.1
    %         results{i+1,copynum_from_Homer_indx}=20;
    %     end
