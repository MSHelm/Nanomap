function program_copy_number_qualifiers_nonormalization

the_folder='Z:\user\mhelm1\Nanomap_Analysis\Data\total';
cd(the_folder);
DiffInt=load('Z:\user\mhelm1\Nanomap_Analysis\Data\total\DifferentialIntensities_nonormalization.mat');
DiffInt=DiffInt.tab;
...
xlswrite('SpineTypeCorrection_nonormalization.xlsx',results)

results=cell2table(results,'VariableNames',{'Name','UID','Corrected_Mush','Corrected_Flat','Corrected_Other',});
save('SpineTypeCorrection_nonormalization.mat','results');
